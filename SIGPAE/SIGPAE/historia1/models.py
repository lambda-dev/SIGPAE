...
class Programa(models.Model):
    ...
    tipo = models.CharField('Tipo', blank=False,max_length=30)
...
class Document(models.Model):
    ...
    fecha_vigano = models.IntegerField('Año',blank=True, validators=[MaxValueValidator(2017), MinValueValidator(1969)], null=True)
